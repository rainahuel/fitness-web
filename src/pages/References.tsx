    ...
    <section className="section centered-page">
      <div className="box box-content">
        ...
        <ul>
          ...
          <li className="mt-3">
            <strong>Starting Strength:</strong><br />
            Rippetoe M (2005).{" "}
            <a href="https://startingstrength.com" target="_blank" rel="noopener noreferrer">
              Starting Strength: Basic Barbell Training.
            </a><br />
            A beginner strength program focused on compound lifts and linear progression.
          </li>

          <li className="mt-3">
            <strong>German Volume Training (GVT):</strong><br />
            Poliquin C (1996).{" "}
            <a href="https://www.t-nation.com/workouts/german-volume-training/" target="_blank" rel="noopener noreferrer">
              The Original GVT – 10 Sets of 10.
            </a><br />
            High-volume program focused on hypertrophy using compound lifts.
          </li>
        ...
        <ul>
          ...
          <li className="mt-3">
            ...
            <a href="https://jissn.biomedcentral.com/articles/10.1186/1550-2783-11-20" target="_blank" rel="noopener noreferrer">
              Evidence-based recommendations for contest prep.
            </a>
          </li>
          <li className="mt-3">
        ...
        <ul>
          <li>
            ...
            <a href="https://pubmed.ncbi.nlm.nih.gov/15883556/" target="_blank" rel="noopener noreferrer">
              Comparison of predictive equations for resting metabolic rate.
            </a>
          </li>
          <li className="mt-3">
          ...
          <li className="mt-3">
            ...
            This calculator uses science-based formulas and published metabolic data, but individual results may vary.
            Always consider tracking your own progress and consulting a health professional if needed.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Contest prep & fat loss:</strong><br />
            Helms ER, Aragon AA, Fitschen PJ (2014).{" "}
            <a href="https://jissn.biomedcentral.com/articles/10.1186/1550-2783-11-20" target="_blank" rel="noopener noreferrer">
              Recommendations for natural bodybuilders.
            </a>
          </li>
          <li className="mt-3">
